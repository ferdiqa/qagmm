...
WebUI.navigateToUrl('https://meetingmarket-iut.de/suche/?dest=bremen&firstday=20180217&dur=1&so=2&rc_1=1&sr_1=false&rp1_1=10&rs1_1=Block&lob=1&lng=de-DE&ccur=EUR&testhotels=1')

WebUI.click(findTestObject('Booking/Prod/h6_'))
