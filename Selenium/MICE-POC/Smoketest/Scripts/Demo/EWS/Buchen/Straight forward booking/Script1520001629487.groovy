...
WebUI.authenticate('http://meetingmarket-demo.de/', 'meetingmarketdemo', 'Demo2016', 12, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setViewPortSize(1280, 768)

WebUI.navigateToUrl('http://meetingmarket-demo.de/suche/?dest=berlin&firstday=20180217&dur=1&so=2&rc_1=1&sr_1=false&rp1_1=10&rs1_1=Block&lob=1&lng=de-DE&ccur=EUR')
...
WebUiBuiltInKeywords.click(findTestObject('Booking/1 und 1 webmail/span_DEMOSERVER Besttigen Sie'))
...
WebUI.switchToWindowTitle('Reservierung bestätigt - meetingmarket-demo.de', FailureHandling.STOP_ON_FAILURE)
